...
{ "ER_unused_2", 1185, "You should never see it" },
...
{ "ER_LAST_MYSQL_ERROR_MESSAGE", 1862, "\"" },
...
{ "ER_UNSED", 1928, "Internal error: \'%-.192s\'" },
...
{ "ER_INCORRECT_GTID_STATE", 1941, "Could not parse GTID list for GTID_POS" },
...
{ "ER_GTID_START_FROM_BINLOG_HOLE", 1951, "The binlog on the master is missing the GTID %u-%u-%llu requested by the slave (even though both a prior and a subsequent sequence number does exist), and GTID strict mode is enabled" },
