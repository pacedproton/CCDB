...
static SYMBOL symbols[] = {
    { "CCDB_OPENDB",      SYM(CCDB_OPENDB_SYM)},
    { "CCDB_CLOSEDB",     SYM(CCDB_CLOSEDB_SYM)},
    { "CCDB_PORT",        SYM(CCDB_PORT_SYM)},
    { "CCDB_OPENTABLE",   SYM(CCDB_OPENTABLE_SYM)},
    { "CCTABLES",         SYM(CCDB_SHOW_CCTABLES_SYM)},
    { "CCDB_PUBLISH_STATUS",SYM(CCDB_PUBLISH_STATUS_SYM)},
    { "CCDB_STATUS",      SYM(CCDB_SHOW_STATUS_SYM)},
    { "CCDB_PUBLISH",     SYM(CCDB_PUBLISH_SYM)},
    { "CCDB_LOCK_CCTABLE",     SYM(CCDB_LOCK_CCTABLE_SYM)},
    { "CCDB_UNLOCK_CCTABLE",   SYM(CCDB_UNLOCK_CCTABLE_SYM)},
  { "&&",		SYM(AND_AND_SYM)},
  { "<",		SYM(LT)},
  { "<=",		SYM(LE)},
  { "<>",		SYM(NE)},
